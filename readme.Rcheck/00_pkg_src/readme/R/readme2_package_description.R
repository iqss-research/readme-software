...
#'
#'   \item \code{build_backend} creates a conda environment with TensorFlow installed. Run this once
#'   before using the package for the first time.
#'
#'   \item \code{initialize_tensorflow} loads the TensorFlow backend. Call this at the start of each
#'   R session before using \code{readme}.
#'
#'   \item \code{tensorflow_available} checks whether TensorFlow is available and properly configured.
#' }
#'
#' @section Usage:
