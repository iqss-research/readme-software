...
readme <- function(dfm, labeledIndicator, categoryVec, 
  ...
  Spread_contrib       = 0.01 * tf$reduce_mean(tf$log(tf$clip_by_value(Spread_tf,0.01, 0.30)))
  #Spread_contrib       = 0.001 * tf$reduce_mean(tf$minimum(Spread_tf, 0.30))
  ...
  for(iter_i in 1:nboot){ 
      ...
      plot( c(sess$run(Spread_tf )), main = "THIS")
      print("Done training...!")
